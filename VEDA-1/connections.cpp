...
//Развертка блока с точками на странице профиля
	...
	QObject::connect(ui->dataChange, &QPushButton::clicked, [=]() {
		if (ui->edite->height() == 626) {
			ui->edite->setGeometry(90, 670, 571, 51);
			...
			ui->edite->setGeometry(90, 95, 571, 626);
